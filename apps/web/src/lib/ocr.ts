...

{
  ...
  "prefix": "คำนำหน้า — ใช้ นาย / นาง / นางสาว / Mr. / Mrs. / Miss เท่านั้น (น.ส. หรือ นส. หรือ นางสาว ทุกรูปแบบให้ใช้ นางสาว) หรือ null",
...
export async function geminiParseDocument(
  ...
  // Normalize prefix: น.ส. / นส. / นส → นางสาว (OCR may return abbreviation variants)
  if (raw.prefix && /^น\.?ส\.?$/.test(raw.prefix.trim())) raw.prefix = 'นางสาว'
  // Normalize English Miss variants
  if (raw.prefix === 'Ms.' || raw.prefix === 'Ms' || raw.prefix === 'Miss.') raw.prefix = 'Miss'
