...
export const TEMPLATE_REGISTRY: TemplateDefinition[] = [
  ...
  // ─── Payment Schedule ────────────────────────────────────────
  {
    ...
    language: 'th_en',
    filename: 'installment_schedule_th_en.docx',
  ...
  // ─── Termination / Cancellation / End ────────────────────────
  {
    ...
    mdFilename: 'termination_notice_th_en.md',
  ...
  },
  {
    ...
    language: 'th_en',
    filename: 'cancellation_th_en.docx',
    mdFilename: 'cancellation_th_en.md',
  ...
  },
  {
    ...
    language: 'th_en',
    filename: 'end_contract_th_en.docx',
    mdFilename: 'contract_end_th_en.md',
    label: 'หนังสือสิ้นสุดสัญญา',
    languageLabel: 'ไทย + อังกฤษ',
    hasFurniture: false,
    hasPaymentSchedule: false,
    hasBuiltInSignatures: true,
    requiredVars: ['ชื่อผู้เช่า', 'ชื่อผู้ให้เช่า', 'สิ้นสุดสัญญาวันที่'],
    imageVars: [],
  },
]
