...
export default function EditFaqForm({ faq }: { faq: FaqItem }) {
  ...
  return (
    <div className="p-4 lg:p-8 pt-6 max-w-2xl">
      ...
      <h1 className="text-xl font-bold text-gray-900 mb-6">แก้ไขคำถาม FAQ</h1>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 space-y-4">
          ...
          <div className="flex items-center gap-3 py-2 border-t border-gray-100">
            ...
            <div>
              <p className="text-sm font-medium text-gray-700">{form.is_published ? 'เผยแพร่แล้ว' : 'ซ่อนอยู่'}</p>
              <p className="text-xs text-gray-400">{form.is_published ? 'คำถามแสดงในหน้า FAQ' : 'ยังไม่แสดงต่อสาธารณะ'}</p>
            </div>
          </div>
        </div>
