...
export default function EditBannerForm({ banner }: { banner: Banner }) {
  ...
  const [form, setForm] = useState({
    ...
    show_search: banner.show_search ?? true,
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {isHero && (
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 space-y-3">
            ...
            <p className="text-xs text-gray-400">Tailwind gradient classes เช่น from-blue-900 via-blue-700 to-indigo-800</p>
          </div>
        )}
