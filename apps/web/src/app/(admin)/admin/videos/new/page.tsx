...
export default function NewVideoPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (!videoId)                 { setError('YouTube URL ไม่ถูกต้อง กรุณาตรวจสอบอีกครั้ง'); return }
    setError('')
  ...
  return (
    <div className="p-4 lg:p-8 pt-6 max-w-2xl">
      ...
      <h1 className="text-xl font-bold text-gray-900 mb-6">เพิ่มวิดีโอ</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 space-y-4">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-400 mt-1">รองรับ youtube.com/watch, youtu.be, /embed/, /shorts/</p>
            {thumbUrl && (
          ...
          <div>
            ...
            <input
              ...
              placeholder="เช่น ดูการใช้งาน Proppsy"
              className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Watch Proppsy in action"
              className="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="คำอธิบายสั้นๆ เกี่ยวกับวิดีโอนี้"
