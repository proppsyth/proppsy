...
import { ArrowLeft, Pencil, Phone, MessageCircle, CreditCard, Home } from 'lucide-react'
          ...
          {o.id_card_url && (
            <Section title="รูปบัตรประชาชน">
              <div className="relative w-64 h-40 rounded-lg overflow-hidden border border-gray-200">
                <Image src={o.id_card_url} alt="บัตรประชาชน" fill className="object-cover" sizes="256px" />
              </div>
            </Section>
          )}
          ...
          {o.signature_url && (
            <Section title="ลายเซ็น">
              <div className="relative w-52 h-24 rounded-lg overflow-hidden border border-gray-200 bg-white">
                <Image src={o.signature_url} alt="ลายเซ็น" fill className="object-contain p-2" sizes="208px" />
              </div>
            </Section>
          )}
