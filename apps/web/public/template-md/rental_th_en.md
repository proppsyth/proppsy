...
| {size:8}ซึ่งรวมถึงอุปกรณ์ตกแต่งและเฟอร์นิเจอร์ที่อยู่ภายในบริเวณขอบเขตที่มีกรรมสิทธิ์โดยถูกต้อง ตามที่ระบุไว้ในสำเนารายการแนบท้ายมาพร้อมกับสัญญาฉบับนี้ ซึ่งต่อไปนี้เรียกว่า "ทรัพย์สิน"{/size} | |
| 10 | 0 |
{space:8}
...
| | {size:8}"ผู้เช่า" ได้ชำระค่าเช่าสำหรับเดือนแรกของสัญญาเรียบร้อยแล้วในวันที่เซ็นสัญญาฉบับนี้{/size} |
| 0.5 | 9.5 |

| 2.3 | The Community, Administration and Maintenance Fee (CAM) shall be the responsibility of the Lessor. |
| 0.5: | 9.5 |

| | {size:8}"ผู้ให้เช่า" เป็นผู้ชำระค่าส่วนกลางที่เรียกเก็บโดยนิติบุคคลของโครงการที่ "ทรัพย์สิน" นี้ตั้งอยู่{/size} |
| 0.5 | 9.5 |
...
| | {size:8}หาก "ผู้เช่า" ไม่ได้ชำระค่าเช่าและพ้นระยะกำหนดชำระเกิน 15 วัน ให้ถือว่า "ผู้เช่า" ละเมิดสัญญาเช่า "ผู้ให้เช่า" มีสิทธิ์ยกเลิกสัญญาเช่า และ "ผู้เช่า" ต้องย้ายออกภายใน 7 วัน นับจากได้รับหนังสือยกเลิก{/size} |
| 0.5 | 9.5 |
{space:8}
...
| | {size:8}เงินประกันสัญญา ไม่สามารถนำมาชำระแทนค่าเช่า และ "ผู้เช่า" ไม่สามารถนำมาเป็นข้ออ้างในการไม่ชำระค่าเช่าได้{/size} |
| 0.5 | 9.5 |
...
| | {size:8}สัญญาฉบับนี้จะสมบูรณ์ต่อเมื่อ "ผู้ให้เช่า" ได้รับเงินค่าเช่าตามข้อ 2.1 และ "เงินประกันสัญญา" ตามข้อ 3.1 จาก "ผู้เช่า" อย่างครบถ้วนเรียบร้อยแล้ว{/size} |
| 0.5 | 9.5 |
{space:8}
...
| | {size:8}ห้ามสูบบุหรี่ภายในห้องรวมถึงพื้นที่ระเบียง หาก "ผู้ให้เช่า" พบการสูบบุหรี่ มีสิทธิบอกเลิกสัญญาโดยแจ้งล่วงหน้า 7 วัน และ "ผู้เช่า" ต้องชำระค่าเสียหายตามจริง{/size} |
| 0.5 | 9.5 |
{space:8}
...
| | {size:8}"ผู้ให้เช่า" รับประกันว่าเป็นผู้มีอำนาจปล่อยให้เช่า "ทรัพย์สิน" โดยถูกต้อง{/size} |
| 0.5 | 9.5 |

| 5.2 | {size:8}หาก "ผู้เช่า" ชำระค่าเช่าและปฏิบัติตามข้อตกลงในสัญญาฉบับนี้อย่างครบถ้วน "ผู้ให้เช่า" หรือตัวแทนจะไม่กระทำการใดๆ ที่ก่อให้เกิดความไม่สงบหรือล่วงละเมิดแก่ "ผู้เช่า" ตลอดอายุสัญญา{/size} |
| 0.5: | 9.5 |
...
| | {size:8}"ผู้ให้เช่า" ต้องบำรุงรักษา "ทรัพย์สิน" ให้อยู่ในสภาพพักอาศัยและใช้งานได้ตามปกติ รวมทั้งต้องซ่อมแซมส่วนที่เสียหายที่ไม่ได้เกิดจากการใช้งานผิดลักษณะของ "ผู้เช่า" โดยทันทีที่ได้รับแจ้ง{/size} |
| 0.5 | 9.5 |
{space:8}
...
| | {size:8}หาก "ผู้เช่า" บอกเลิกสัญญาก่อนวันสิ้นสุดสัญญา ต้องแจ้งเป็นลายลักษณ์อักษรล่วงหน้าไม่น้อยกว่า 30 วัน และ "ผู้ให้เช่า" มีสิทธิริบ "เงินประกันสัญญา" ตามข้อ 3.1{/size} |
| 0.5 | 9.5 |
{space:8}
...
| | {size:8}ในวันที่ครบกำหนดสัญญาเช่า "ผู้เช่า" จะต้องย้ายและขนย้ายทรัพย์สินที่เป็นของ "ผู้เช่า" ออกจาก "ทรัพย์สิน" และส่งมอบ "ทรัพย์สิน" คืนแก่ "ผู้ให้เช่า"{/size} |
| 0.5 | 9.5 |

| 7.2 | {size:8}หาก "ผู้เช่า" ไม่สามารถทำตามข้อตกลงที่ระบุไว้ในข้อ 7.1 "ผู้เช่า" ตกลงว่า{/size} |
| 0.5: | 9.5 |

| (a) | {size:8}ให้ถือว่าทรัพย์สินของ "ผู้เช่า" ที่ยังคงอยู่ภายใน "ทรัพย์สิน" ตกเป็นกรรมสิทธิ์ของ "ผู้ให้เช่า"{/size} |
| 1: | 9 |
...
| | {size:8}"ผู้เช่า" ต้องชำระค่าเช่าเป็นจำนวนครึ่งหนึ่งของค่าเช่ารายเดือน หากไม่ย้ายออกภายใน 15 วัน และเป็นจำนวนเท่ากับค่าเช่าหนึ่งเดือน หากใช้เวลาเกินกว่า 15 วันและไม่เกิน 30 วัน รวมทั้งชำระค่าปรับ <<ค่าปรับเติมลูกน้ำ>> บาท (<<ค่าปรับตัวอักษร>>) / วัน นับจากวันที่หมดสัญญา{/size} |
| 1 | 9 |
{space:8}
...
| {size:8}สัญญาฉบับนี้อยู่ภายใต้กฎหมายของประเทศไทย สัญญาฉบับนี้เขียนขึ้นทั้งภาษาไทยและภาษาอังกฤษ หากมีความไม่สอดคล้องกัน ให้ยึดถือข้อบังคับในภาษาอังกฤษเป็นหลัก{/size} | |
| 10 | 0 |
{space:8}
...
| 9.2 | On the end of the contract, the Lessee agrees to allow the Lessor to deduct the cost of cleaning the room <<ค่าทำความสะอาดเติมลูกน้ำ>> Baht (<<ค่าทำความสะอาดตัวอักษรen>>) and the cost of cleaning <<จำนวนแอร์>> air conditioner(s) <<ค่าล้างแอร์เติมลูกน้ำ>> Baht each (<<ค่าล้างแอร์ตัวอักษรen>>), totaling <<รวมค่าล้างแอร์เติมลูกน้ำ>> Baht (<<รวมค่าล้างแอร์ตัวอักษรen>>), grand total <<รวมทำความสะอาดและล้างแอร์เติมลูกน้ำ>> Baht (<<รวมทำความสะอาดและล้างแอร์ตัวอักษรen>>) from the security deposit. |
| 0.5: | 9.5 |

| | {size:8}ในวันสิ้นสุดสัญญา "ผู้เช่า" ยินยอมให้ "ผู้ให้เช่า" หักค่าทำความสะอาดห้อง <<ค่าทำความสะอาดเติมลูกน้ำ>> บาท (<<ค่าทำความสะอาดตัวอักษร>>) และค่าล้างแอร์ <<จำนวนแอร์>> ตัว ตัวละ <<ค่าล้างแอร์เติมลูกน้ำ>> บาท (<<ค่าล้างแอร์ตัวอักษร>>) เป็นจำนวน <<รวมค่าล้างแอร์เติมลูกน้ำ>> บาท (<<รวมค่าล้างแอร์ตัวอักษร>>) รวมทั้งสิ้น <<รวมทำความสะอาดและล้างแอร์เติมลูกน้ำ>> บาท (<<รวมทำความสะอาดและล้างแอร์ตัวอักษร>>) โดยหักจากเงินประกัน{/size} |
| 0.5 | 9.5 |
{space:12}
...
| {size:8}สัญญาฉบับนี้ทำขึ้น 2 ฉบับ มีข้อความตรงกัน "ผู้ให้เช่า" และ "ผู้เช่า" ถือไว้คนละฉบับ ทั้งสองฝ่ายได้อ่านและเห็นว่าถูกต้องตามวัตถุประสงค์ของทั้ง 2 ฝ่าย จึงลงลายมือชื่อไว้ต่อหน้าพยาน{/size} | |
| 10 | 0 |
{space:8}
